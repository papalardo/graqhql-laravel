                    ...
                    <div class="vx-row no-gutter justify-center items-center">
                        ...
                        <div class="vx-col sm:w-full md:w-full lg:w-1/2 d-theme-dark-bg">
                            <div class="p-8">
                                ...
                                <ApolloMutation
                                    :mutation="require('@/graphql/auth/mutations/login.gql')"
                                ...
                                >
                                    <template v-slot="{ mutate, loading, error }">
                                        ...
                                        <vs-button class="float-right" :disabled="!validateForm" @click="mutate()">Login</vs-button>
                                    </template>
                                </ApolloMutation>
                            </div>
                        </div>
